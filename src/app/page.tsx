...
import { Menu, X, Shield, Clock, DollarSign, CheckCircle2, Star, ChevronRight, Tractor, Home as HomeIcon, Zap, Heart } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-[#1D1D1F] hover:text-[#007AFF] transition-colors text-sm font-medium">
                Features
              </a>
              <a href="#how-it-works" className="text-[#1D1D1F] hover:text-[#007AFF] transition-colors text-sm font-medium">
                How It Works
              </a>
              <a href="#testimonials" className="text-[#1D1D1F] hover:text-[#007AFF] transition-colors text-sm font-medium">
                Testimonials
              </a>
              <Button variant="ghost" className="text-[#1D1D1F] hover:text-[#007AFF]">
                Log In
              </Button>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200/50">
            <div className="px-4 py-4 space-y-3">
              <a href="#features" className="block text-[#1D1D1F] hover:text-[#007AFF] py-2 text-sm font-medium">
                Features
              </a>
              <a href="#how-it-works" className="block text-[#1D1D1F] hover:text-[#007AFF] py-2 text-sm font-medium">
                How It Works
              </a>
              <a href="#testimonials" className="block text-[#1D1D1F] hover:text-[#007AFF] py-2 text-sm font-medium">
                Testimonials
              </a>
              <div className="pt-3 border-t border-gray-200 space-y-2">
                <Button variant="ghost" className="w-full text-[#1D1D1F]">
                  Log In
                </Button>
